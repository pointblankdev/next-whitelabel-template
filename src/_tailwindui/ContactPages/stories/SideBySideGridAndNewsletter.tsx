            ...
            <header className="relative pb-24 bg-light-blue-800 sm:pb-32">
                <div className="absolute inset-0">
                    <img
                        ...
                        alt=""
                    />
                    <div className="absolute inset-0 bg-gradient-to-l from-light-blue-800 to-cyan-700" style={{ mixBlendMode: "multiply" }} aria-hidden="true" />
                </div>
                ...
                <div className="relative mt-24 max-w-md mx-auto px-4 sm:max-w-3xl sm:mt-32 sm:px-6 lg:max-w-7xl lg:px-8">
                    ...
                    <p className="mt-6 text-xl text-cyan-100 max-w-3xl">
                        Mattis amet hendrerit dolor, quisque lorem pharetra. Pellentesque lacus nisi urna, arcu sociis eu. Orci vel lectus nisl eget eget ut consectetur. Sit justo
                ...
                <div className="max-w-md mx-auto py-12 px-4 sm:max-w-3xl sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
                    <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                        <div className="space-y-8 xl:col-span-1">
                            ...
                            <p className="text-warm-gray-500 text-base">Making the world a better place through constructing elegant hierarchies.</p>
                    ...
                    <div className="mt-12 border-t border-warm-gray-200 pt-8">
                        <p className="text-base text-warm-gray-400 xl:text-center">&copy; 2020 Workflow, Inc. All rights reserved.</p>
                    </div>
                </div>
            </footer>
        </div>
