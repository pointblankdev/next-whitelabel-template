                ...
                <Popover className="relative">
                    {({ open }) => (
                        <>
                                            ...
                                            {({ open }) => (
                                                <>
                                                    ...
                                                    >
                                                        <span>Solutions</span>
                                                        <ChevronDownIcon
                                                            className={classNames(open ? "text-white" : "text-indigo-300", "ml-2 h-5 w-5 group-hover:text-white")}
                                                            aria-hidden="true"
                                                        />
                                                    </Popover.Button>
                                                        ...
                                                        >
                                                            <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                                                                <div className="relative bg-white py-6 px-5 grid gap-6 sm:gap-8 sm:p-8">
                                                                    {solutions.map((item) => (
                                                                        <a key={item.name} href={item.href} className="-m-3 rounded-lg p-3 flex items-start hover:bg-gray-50">
                                            ...
                                            {({ open }) => (
                                                <>
                                                    ...
                                                    <Transition
                                                        ...
                                                        leaveTo="opacity-0 translate-y-1"
                                                    >
                                                        <Popover.Panel static className="absolute z-10 left-1/2 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-md sm:px-0">
                                                            <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                                                                <div className="relative bg-white py-6 px-5 grid gap-6 sm:gap-8 sm:p-8">
                                                                    {resources.map((item) => (
                            ...
                            >
                                <Popover.Panel focus static className="absolute z-10 top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
                        ...
                        <section key={tier.name}>
                            ...
                            {sections.map((section) => (
                                <table key={section.name} className="w-full">
                                    <caption className="bg-gray-50 border-t border-gray-200 py-3 px-4 text-sm font-medium text-gray-900 text-left">{section.name}</caption>
                                    <thead>
                                        <tr>
                    ...
                    <table className="w-full h-px table-fixed">
                        ...
                        <thead>
                            <tr>
                                ...
                                {tiers.map((tier) => (
                                    <th key={tier.name} className="w-1/4 pb-4 px-6 text-lg leading-6 font-medium text-gray-900 text-left" scope="col">
                                        {tier.name}
                                    </th>
                                ))}
                            </tr>
